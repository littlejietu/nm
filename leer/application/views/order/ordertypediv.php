...
<div id="Payment" class="tkBox">
    ...
    <form action="<?php echo base_url() ?>/orderaction/payOrder" method="post">
...
<div id="Distribution" class="tkBox">
    ...
    <form action="<?php echo base_url() ?>/orderaction/sendGoods" method="post">
        <input type="hidden" name="order_id" class="jsReplaceOrderId">
        <table cellpadding="0" cellspacing="0" class="addGoods_tab">
            <tr height="50">
                <td>配送物流：</td>
...
<div id="ReturnGoods" class="tkBox">
    ...
    <form action="<?php echo base_url() ?>/orderaction/changeGoods" method="post">
        <input type="hidden" name="order_id" class="jsReplaceOrderId">
...
<div id="Refund" class="tkBox">
    ...
    <form action="<?php echo base_url() ?>/orderaction/exitMoney" method="post">
        <input type="hidden" name="order_id" class="jsReplaceOrderId">
        <table cellpadding="0" cellspacing="0" class="addGoods_tab">
            <tr height="40">
                <td>退款金额：</td>
