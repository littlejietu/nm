...
class userAction extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('system/userlist', $data);
    }
     ...
     * 读取红包赠送用户列表
     **/
    public function indexuserlist($page = 1)
    {
        $this->L('usermodel');
        ...
        $data['userList'] = $userList;
        $this->load->view('ucenter/userlist', $data);
    }
    ...
    public function givePower($userId)
    {
        ...
        $this->load->view('system/givepower', $data);
    }
    ...
    public function getCollectList($page = 1)
    {
        ...
        $this->load->view('system/myCollection', $data);
    }
    ...
    public function  getCollectionArticleList($page = 1)
    {
        ...
        $this->load->view('system/myCollectionArticle', $data);
    }
