    ...
    <table class="listTab" cellpadding="0" cellspacing="0" bordercolor="#e4e4e4" border="1">
        ...
        <?php foreach((array)$goodsSkuList as $k => $v){?>
            <tr height="30">
                ...
                <?php if( $userLevel < 2){?>
                    <td>
                        <a href="<?php echo base_url()?>/index.php/sourceaction/addGoodsSkuValue/<?php echo $v->goods_sku_key_id?>">添加属性值</a><span class="caozuo_line">|</span>
                        <a href="<?php echo base_url()?>/index.php/sourceaction/addgoodssku/<?php echo $v->goods_sku_key_id?>">编辑</a><span class="caozuo_line">|</span>
            ...
            foreach($v->sku_value as $ka => $va){
                    ...
                    <tr  height="30">
                        ...
                        <?php if( $userLevel < 2){?>
                            <td><a href="<?php echo base_url()?>/index.php/sourceaction/addGoodsSkuValue/<?php echo $v->goods_sku_key_id?>/<?php echo $va->goods_sku_value_id?>">编辑</a><span class="caozuo_line">|</span>
