...
<head>
    ...
    <link href="<?php echo base_url();?>resources/backstage/css/common.css" rel="stylesheet">
    <link href="<?php echo base_url();?>resources/backstage/css/login.css" rel="stylesheet">
    <link href="<?php echo base_url();?>resources/backstage/css/index.css" rel="stylesheet">
    <link href="<?php echo base_url();?>resources/backstage/css/right.css" rel="stylesheet">
    ...
    <script language="javascript" src="<?php echo base_url();?>resources/backstage/My97DatePicker/WdatePicker.js"></script>
</head>
<body>