                ...
                <div class="clearfix uitopg">
                    <div class="transa">
                        <div class="aut_bti clearfix">
                          <h3 class="fl">档期管理</h3>
              <a class="fr addto TX-win-open" href="javascript:;"><i></i>添加档期</a>
                        </div>
                        <table class="tran_tab" width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><?php echo date('Y-m-d',$a['dodate']);?></td>
                              <td style="text-align:left"><?=$a['thing'];?></td>
                              <td class="operat">
...
<div class="popover complaint addcust">
  <div class="compl_top"><span class="fl">添加档期</span><input type="hidden" name="sid" id="sid" value=""><a href="javascript:;" title="关闭" class="close fr TX-win-close">×</a></div>
  <div class="compl_con">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="80"><font>时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间：</font></td>
              <td><input name="dodate" id="dodate" type="text" class="txt" onclick="J.calendar.get();"/></td>
            </tr>
            <tr><td height="10"></td></tr>
            <tr>
              <td valign="top"><font>行&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;程：</font></td>
              <td><textarea class="txt text" name="thing" id="thing" cols="" rows=""></textarea></td>
            </tr>
            <tr><td height="10"></td></tr>
            <tr>
              <td>&nbsp;</td>
...
<script type="text/javascript" src="<?php echo _get_cfg_path('js')?>pages/m/schedule.js"></script>
</html>